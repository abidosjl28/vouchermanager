                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contact-contacts.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('contact_phone_1') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_phone_1" id="contact_phone_1" value="{{ old('contact_phone_1', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_phone_2') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_phone_2" id="contact_phone_2" value="{{ old('contact_phone_2', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_skype') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_skype" id="contact_skype" value="{{ old('contact_skype', '') }}">
