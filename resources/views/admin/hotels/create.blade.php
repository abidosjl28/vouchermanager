                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.hotels.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('phone_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', '05') }}">
                        ...
                        <div class="form-group {{ $errors->has('email_address') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="email_address" id="email_address" value="{{ old('email_address', 'email@domain.com') }}">
